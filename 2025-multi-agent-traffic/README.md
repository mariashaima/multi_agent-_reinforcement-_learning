...
Forcing the ego vehicle to brake sharply

Setting up opportunities for cut‑offs or rear‑end collisions
...
Using off‑road shortcuts to overtake

Creating unpredictable lateral motion
...
Immediate re‑entry into the ego lane

This creates a realistic and challenging overtaking scenario that stresses perception and planning modules.
